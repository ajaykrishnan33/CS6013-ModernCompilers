...
public class AliasAnalyser<R, A> implements GJVisitor<R, A> {
    ...
    public R visit(Query n, A argu) {
        ...
        AliasQuery q = GlobalSymTab.currentFunc.addAliasQuery(x, y, null);
        n.query = q;
    ...
    public R visit(AssignmentStatement n, A argu) {
        ...
        if(argu.toString().equals("eval")){
            ...
            if(GlobalSymTab.userDefinedType(id) || ((ArrayList<String>)val).get(0).equals("2"))
            {
                String exp = val.toString();
    ...
    public R visit(FieldAssignmentStatement n, A argu) {
        ...
        if(argu.toString().equals("eval")){
            ...
            if(GlobalSymTab.userDefinedType(type1)){
                ArrayList<String> res = new ArrayList<String>();
                res.add("fieldassgn");
                res.add(id1);
                res.add(id2);
    ...
    public R visit(MessageSend n, A argu) {
        ...
        if(argu.toString().equals("eval")){
            ...
            String args = n.f4.accept(this, argu).toString();
            ArrayList<String> res =  new ArrayList<String>();
            res.add("2"); //type 2
            res.add(prim);
            res.add(func);
