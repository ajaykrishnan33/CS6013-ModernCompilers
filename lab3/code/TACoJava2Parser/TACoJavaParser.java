...
public class TACoJavaParser implements TACoJavaParserConstants {
  ...
  static final public VoidMessageSendStatement VoidMessageSendStatement() throws ParseException {
   ...
   Token n2;
    ...
    n2 = jj_consume_token(SEMICOLON);
            n1 = JTBToolkit.makeNodeToken(n2);
     {if (true) return new VoidMessageSendStatement(n0,n1);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000000,0xf0402000,0x1000000,0x800000,0x0,0x800000,0x0,0x800000,0xf0402000,0x0,0x800000,0x2000,0xe0000000,0xf0402000,0x10400000,0x10000000,0x0,0x10000000,0x400000,0x10000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x3708,0x0,0x2001,0x10,0x2001,0x10,0x2001,0x3708,0x10000,0x2001,0x0,0x400,0x3708,0x3308,0x3200,0x10000,0x3300,0x8,0x3200,};
   }
